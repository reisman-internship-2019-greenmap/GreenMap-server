...
const { greenScoreLookup } = require('../utils/wikirates');
/**
    ...
    connectDb().then(async () => {
        ...
        try {
            ...
            if(!('brand' in datafinitiRes.body.records[0]) && !('manufacturer' in datafinitiRes.body.records[0])) {
                ...
                let greenScoreRes = await greenScoreLookup({manufacturer: (datafinitiRes.body.records[0].manufacturer || datafinitiRes.body.records[0].brand)});
